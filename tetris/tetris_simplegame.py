...
class TetrisApp(object):
    ...
    def __init__(self):
        ...
        self.rot_idx = rand(4)
        self.next_rotation = [0, 0, 0, 0]
        self.next_rotation[self.rot_idx] = 1
        # rotate stone
        if self.rot_idx == 1:
            self.next_stone = rotate_clockwise(self.next_stone)
        elif self.rot_idx == 2:
            self.next_stone = rotate_anticlockwise(self.next_stone)
        elif self.rot_idx == 3:
            self.next_stone = rotate_half(self.next_stone)
        self.init_game()
