...
def remove_row(board, row):
    del board[row]
    return [[0 for i in range(cols)]] + board # add new line on top (highest row)
...
class TetrisApp(object):
    def __init__(self):
        ...
        pygame.event.set_blocked(pygame.MOUSEMOTION) # block mouse movements as not needed
    ...
    def new_stone(self):
        ...
        self.next_stone = tetris_shapes[rand(len(tetris_shapes))]
        self.stone_x = int(cols / 2 - len(self.stone[0])/2) ##### always 3???
        self.stone_y = 0
    ...
    def init_game(self):
        ...
        self.score = 0 #### To Do
        self.lines = 0 #### TO DO
        #pygame.time.set_timer(pygame.USEREVENT+1, 1000) ### delete???
    ...
    def add_cl_lines(self, n):
        ...
        self.lines += n
        self.score += linescores[n] * self.level #### To do: set score!
    ...
    def run(self):
        ...
        while 1:
            ...
            action = random.choice(list(key_actions.values())[1:])
